...
/*PreparedStatement는 Statement와 달리 최초 한 번 쿼리를 파싱하고 컴파일하고 캐싱하여 다시 재해석하는
* 과정(비용)을 생략함으로 인해 불완전하게 작성된 쿼리 샐행의 경우는 Statement 보다 빠름*/
public class Application2 {
    public static void main(String[] args) {
        ...
        /*PreparedStatenent는 Statement와 달리 placeholder(?)를 활용해 하나의 문자열 형태로 쿼리를 작성*/
        ...
        try {
            ...
            pstmt.setInt(1, menuCode);//위치 홀더(?)가 나영된 순서 왼쪽 -> 오른쪽 순서대로 채워감
